<template>
  <div class="addEdit-block">
    ...
    >
      <el-row>
                        <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="景区名称" prop="jingqumingcheng">
          <el-input v-model="ruleForm.jingqumingcheng" 
              placeholder="景区名称" clearable ></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="景区名称" prop="jingqumingcheng">
              <el-input v-model="ruleForm.jingqumingcheng" 
                placeholder="景区名称" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
        ...
        <div v-else>
	      ...
	      <el-input v-model="ruleForm.fenlei"
                placeholder="分类" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="景区星级" prop="jingquxingji">
          <el-select v-model="ruleForm.jingquxingji" placeholder="请选择景区星级">
            <el-option
                v-for="(item,index) in jingquxingjiOptions"
                v-bind:key="index"
                :label="item"
                :value="item">
            </el-option>
        ...
        <div v-else>
          <el-form-item class="input" label="景区星级" prop="jingquxingji">
	      <el-input v-model="ruleForm.jingquxingji"
                placeholder="景区星级" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="24">  
          ...
          <el-form-item class="input" label="门票价格" prop="menpiaojiage">
              <el-input v-model="ruleForm.menpiaojiage" 
                placeholder="门票价格" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="景区地址" prop="jingqudizhi">
          <el-input v-model="ruleForm.jingqudizhi" 
              placeholder="景区地址" clearable ></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="景区地址" prop="jingqudizhi">
              <el-input v-model="ruleForm.jingqudizhi" 
                placeholder="景区地址" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="咨询热线" prop="zixunrexian">
          <el-input v-model="ruleForm.zixunrexian" 
              placeholder="咨询热线" clearable ></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="咨询热线" prop="zixunrexian">
              <el-input v-model="ruleForm.zixunrexian" 
                placeholder="咨询热线" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                                                                                                        </el-row>
                                                                                                                                                                                                                                                                            <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="景区介绍" prop="jingqujieshao">
                <editor 
                    style="min-width: 200px; max-width: 600px;"
                    v-model="ruleForm.jingqujieshao" 
                    class="editor" 
                    action="file/upload">
                </editor>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.jingqujieshao" label="景区介绍" prop="jingqujieshao">
                    <span v-html="ruleForm.jingqujieshao"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
      ...
      if(this.type=='info'||this.type=='else'){
        ...
        for (var o in obj){
            ...
            continue;
                    ...
                    if(o=='jingquxingji'){
            this.ruleForm.jingquxingji = obj[o];
            continue;
          }
                    if(o=='tupian'){
            ...
            continue;
                    ...
                    if(o=='jingqujieshao'){
            this.ruleForm.jingqujieshao = obj[o];
            continue;
          }
                    if(o=='clicktime'){
