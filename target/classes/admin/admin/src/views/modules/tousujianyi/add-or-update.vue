          ...
          <el-form-item class="input" label="手机" prop="shouji">
              <el-input v-model="ruleForm.shouji" 
                placeholder="手机" readonly></el-input>
                                                                                                                                              ...
                                                                                                                                              <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="投诉建议" prop="tousujianyi">
                <editor 
                    style="min-width: 200px; max-width: 600px;"
                    v-model="ruleForm.tousujianyi" 
                    class="editor" 
                    action="file/upload">
                </editor>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.tousujianyi" label="投诉建议" prop="tousujianyi">
                    <span v-html="ruleForm.tousujianyi"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
      ...
      if(this.type=='info'||this.type=='else'){
        ...
        for (var o in obj){
            ...
            continue;
                    ...
                    if(o=='tousujianyi'){
            this.ruleForm.tousujianyi = obj[o];
            continue;
          }
                    if(o=='riqi'){
